...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderPath(path, props, onRender) {
	  onRender(_IndexPage2.default.renderToString(props));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var COMPUTE_ALIGN_REGION = __webpack_require__(234)
...
/***/ function(module, exports) {
	...
	var ExamplePages = exports.ExamplePages = [{
	...
	var DOCS_DEFAULT = exports.DOCS_DEFAULT = APIPages[0].pages.OVERVIEW;
	var EXAMPLES_DEFAULT = exports.EXAMPLES_DEFAULT = ExamplePages[0].pages.SINGLE_TARGET;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var inTriangle = __webpack_require__(152);
	var hasTouch = __webpack_require__(73);

	var normalize = __webpack_require__(79);

	var getMenuOffset = __webpack_require__(78);
	var getConstrainRegion = __webpack_require__(77);
	var getItemStyleProps = __webpack_require__(161);
	var renderSubMenu = __webpack_require__(167);
	var renderChildren = __webpack_require__(166);
	var prepareItem = __webpack_require__(164);

	var propTypes = __webpack_require__(165);
	var ScrollContainer = __webpack_require__(158);
	...
	MenuClass.themes = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageBody = function (_Component) {
	  ...
	  PageBody.prototype.render = function render() {
	    var _props = this.props;
	    var hasSidebar = _props.hasSidebar;
	    var html = _props.html;

	    var props = _objectWithoutProperties(_props, ['hasSidebar', 'html']);

	    return _react2.default.createElement(
	      'div',
	      { className: 'PageBody ' + (hasSidebar ? 'PageBody--hasSidebar' : '') },
	...
	PageBody.propTypes = {
	  hasSidebar: _react2.default.PropTypes.bool
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CodeBlock = __webpack_require__(119);
	...
	var StaticHTMLBlock = function (_Component) {
	  _inherits(StaticHTMLBlock, _Component);

	  function StaticHTMLBlock() {
	    _classCallCheck(this, StaticHTMLBlock);

	    return _possibleConstructorReturn(this, _Component.apply(this, arguments));
	  }

	  StaticHTMLBlock.prototype.render = function render() {
	    ...
	    for (var i = 0; i < blocks.length; i++) {
	      ...
	      switch (i % 4) {
	        case 0:
	          elements.push(_react2.default.createElement('div', { key: i,
	            style: { width: '100%' },
	        ...
	        case 3:
	          es7Content = content;
	          elements.push(_react2.default.createElement(_CodeBlock2.default, { key: i,
	            es5: es5Content,
	            es6: es6Content,
	            es7: es7Content }));
	          break;
	  ...
	  return StaticHTMLBlock;
	}(_react.Component);

	StaticHTMLBlock.propTypes = {
	  html: _react2.default.PropTypes.string.isRequired
	};
	exports.default = StaticHTMLBlock;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(8);
	var normalize = __webpack_require__(79);
	var EVENT_NAMES = __webpack_require__(154);

	var getMenuOffset = __webpack_require__(78);

	var prepareChildren = __webpack_require__(155);

	var Menu = __webpack_require__(31);
	var MenuItemCell = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SideBar = function (_Component) {
	  ...
	  SideBar.prototype.renderGroup = function renderGroup(_ref, index) {
	    var _this2 = this;
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'SideBar-group', key: index },
	      _react2.default.createElement(
	        'h4',
	        { className: 'SideBar-groupTitle' },
	        title
	      ),
	      Object.keys(pages).map(function (key) {
	        return _this2.renderLink(pages[key], key);
	      })
	    );
	  };

	  SideBar.prototype.renderLink = function renderLink(_ref2, key) {
	    var title = _ref2.title;
	    var location = _ref2.location;

	    var arrow = _react2.default.createElement('span', { className: 'arrowBullet' });
	    ...
	    return _react2.default.createElement(
	      'a',
	      { key: key, href: location, target: '_self', className: linkClass },
	      _react2.default.createElement(
	        'span',
	        { className: 'SideBar-itemText' },
	        title
	      ),
	      arrow
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hasOwn      = __webpack_require__(172)
	var getPrefixed = __webpack_require__(170)

	var map      = __webpack_require__(173)
	var plugable = __webpack_require__(174)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var curry   = __webpack_require__(239)
	var matches

	module.exports = curry(function(selector, node){

		matches = matches || __webpack_require__(240)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _targetContainer = __webpack_require__(114);

	var _targetContainer2 = _interopRequireDefault(_targetContainer);
	...
	var SingleTargetApp = function (_Component) {
	    _inherits(SingleTargetApp, _Component);

	    function SingleTargetApp(props) {
	        _classCallCheck(this, SingleTargetApp);

	        return _possibleConstructorReturn(this, _Component.call(this, props));
	    }

	    SingleTargetApp.prototype.render = function render() {
	        return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { href: 'https://github.com/jchristman/react-context-menus/tree/master/examples/00%20Connecting Targets/Single%20Target' },
	                        'Browse the Source'
	                    )
	                )
	            ),
	            ...
	            _react2.default.createElement(_targetContainer2.default, null)
	        );
	    };

	    return SingleTargetApp;
	}(_react.Component);

	exports.default = SingleTargetApp;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactContextMenus = __webpack_require__(117);
	...
	var menu_items = [{
	    ...
	    onClick: function onClick() {
	        return alert('Clicked Item 1!');
	    }
	}, {
	    label: 'Item 2',
	    onClick: function onClick() {
	        return alert('Clicked Item 2!');
	    }
	}, '-', {
	    label: 'Item 3',
	    onClick: function onClick() {
	        return alert('Clicked Item 3 below the divider!');
	    }
	}];

	exports.default = (0, _reactContextMenus2.default)(menu_items)(_target2.default);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactMenus = __webpack_require__(163);
	        ...
	        var Container = function (_React$Component) {
	            ...
	            Container.prototype._renderLayer = function _renderLayer() {
	                ...
	                if (this.state.showContextMenu) {
	                    ...
	                    _reactDom2.default.render(_react2.default.createElement(_reactMenus2.default, { theme: theme, items: wrapped_menu_items, at: [this.state.x, this.state.y] }), this.container);
	                } else {
	                    _reactDom2.default.unmountComponentAtNode(this.container);
	                }
	            };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _context_menu = __webpack_require__(116);
	...
	exports.default = _context_menu2.default;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _APIPage = __webpack_require__(122);

	var _APIPage2 = _interopRequireDefault(_APIPage);

	var _ExamplePage = __webpack_require__(123);
	...
	var APIDocs = {
	    OVERVIEW: __webpack_require__(140)
	};

	var Examples = {
	    SINGLE_TARGET: __webpack_require__(113)
	};

	var IndexPage = function (_Component) {
	    _inherits(IndexPage, _Component);

	    IndexPage.getDoctype = function getDoctype() {
	        return '<!doctype html>';
	    };

	    IndexPage.renderToString = function renderToString(props) {
	        return IndexPage.getDoctype() + _server2.default.renderToString(_react2.default.createElement(IndexPage, props));
	    };
	    ...
	    function IndexPage(props) {
	        ...
	        _this.state = {
	            renderPage: !_this.props.devMode
	        };
	        return _this;
	    }
	    ...
	    IndexPage.prototype.render = function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('link', { rel: 'stylesheet', type: 'text/css', href: this.props.files['main.css'] }),
	                _react2.default.createElement('base', { target: '_blank' })
	            ),
	            _react2.default.createElement(
	                'body',
	                null,
	                this.state.renderPage && this.renderPage(),
	                _react2.default.createElement('script', { dangerouslySetInnerHTML: browserInitScriptObj }),
	                _react2.default.createElement('script', { src: this.props.files['main.js'] })
	            )
	        );
	    };

	    IndexPage.prototype.renderPage = function renderPage() {
	        switch (this.props.location) {
	            case _Constants.Pages.HOME.location:
	                return _react2.default.createElement(_HomePage2.default, null);
	        }

	        for (var groupIndex in _Constants.APIPages) {
	            var group = _Constants.APIPages[groupIndex];
	            var pageKeys = Object.keys(group.pages);

	            for (var i = 0; i < pageKeys.length; i++) {
	                var key = pageKeys[i];
	                var page = group.pages[key];

	                if (this.props.location === page.location) {
	                    return _react2.default.createElement(_APIPage2.default, { example: page,
	                        html: APIDocs[key] });
	                }
	            }
	        }

	        for (var _groupIndex in _Constants.ExamplePages) {
	            var _group = _Constants.ExamplePages[_groupIndex];
	            var _pageKeys = Object.keys(_group.pages);

	            for (var _i = 0; _i < _pageKeys.length; _i++) {
	                var _key = _pageKeys[_i];
	                var _page = _group.pages[_key];
	                var _Component2 = Examples[_key];

	                if (this.props.location === _page.location) {
	                    return _react2.default.createElement(
	                        _ExamplePage2.default,
	                        { example: _page },
	        ...
	        throw new Error('Page of location ' + JSON.stringify(this.props.location) + ' not found.');
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactUpdates = __webpack_require__(10);

	var _ReactUpdates2 = _interopRequireDefault(_ReactUpdates);

	var _StaticHTMLBlock = __webpack_require__(42);

	var _StaticHTMLBlock2 = _interopRequireDefault(_StaticHTMLBlock);
	...
	var CodeBlock = function (_Component) {
	  ...
	  function CodeBlock(props) {
	    ...
	    _this.state = {
	      chosen: false,
	      syntax: _this.props.es5.trim().length && 'es5' || _this.props.es6.trim().length && 'es6' || _this.props.es7.trim().length && 'es7'
	    };
	    return _this;
	  }
	  ...
	  CodeBlock.prototype.handlePreferredSyntaxChange = function handlePreferredSyntaxChange(syntax) {
	  ...
	  CodeBlock.prototype.componentWillUnmount = function componentWillUnmount() {
	    this.unsubscribe();
	  };

	  CodeBlock.prototype.handleSyntaxClick = function handleSyntaxClick(syntax) {
	    this.setState({
	      syntax: syntax,
	      chosen: true
	    });

	    var scrollTopBefore = (0, _reactDom.findDOMNode)(this).getBoundingClientRect().top;
	    setPreferredSyntax(syntax);
	    _ReactUpdates2.default.flushBatchedUpdates();
	    var scrollTopAfter = (0, _reactDom.findDOMNode)(this).getBoundingClientRect().top;

	    window.scroll(window.pageXOffset || window.scrollX, (window.pageYOffset || window.scrollY) - (scrollTopBefore - scrollTopAfter));
	  };
	  ...
	  CodeBlock.prototype.render = function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(_StaticHTMLBlock2.default, { html: this.props[this.state.syntax] })
	      )
	    );
	  };

	  CodeBlock.prototype.renderSyntaxLink = function renderSyntaxLink(syntax) {
	    if (!this.props[syntax] || !this.props[syntax].trim().length) {
	      return;
	    }

	    if (syntax === 'es5' && !this.props.es6.trim().length && !this.props.es7.trim().length) {
	      return;
	    }

	    var active = this.state.syntax === syntax;
	    return _react2.default.createElement(
	      'li',
	...
	CodeBlock.propTypes = {
	  es5: _react.PropTypes.string,
	  es6: _react.PropTypes.string,
	  es7: _react.PropTypes.string
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GITHUB_URL = 'https://github.com/jchristman/react-context-menus';
	var DOCS_LOCATION = _Constants.DOCS_DEFAULT.location;
	var EXAMPLES_LOCATION = _Constants.EXAMPLES_DEFAULT.location;
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { href: './', target: '_self', className: 'NavBar-logoTitle' },
	            'React Context Menus'
	          ),
	          _react2.default.createElement(
	            'p',
	            { className: 'NavBar-logoDescription' },
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { className: 'NavBar-link', href: DOCS_LOCATION, target: '_self' },
	            'Docs'
	          ),
	          _react2.default.createElement(
	            'a',
	            { className: 'NavBar-link', href: EXAMPLES_LOCATION, target: '_self' },
	            'Examples'
	          ),
	          _react2.default.createElement(
	            'a',
	            { className: 'NavBar-link', href: GITHUB_URL },
	            'GitHub'
	          )
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PageBody = __webpack_require__(41);
	...
	var APIPage = function (_Component) {
	  ...
	  APIPage.prototype.render = function render() {
	    return _react2.default.createElement(
	      'div',
	      null,
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(_SideBar2.default, {
	          groups: _Constants.APIPages,
	          example: this.props.example
	        }),
	        _react2.default.createElement(_StaticHTMLBlock2.default, { html: this.props.html })
	      )
	    );
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExamplesPage = function (_Component) {
	  _inherits(ExamplesPage, _Component);
	  ...
	  ExamplesPage.prototype.render = function render() {
	    return _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(_Header2.default, null),
	      _react2.default.createElement(
	        ...
	        { hasSidebar: true },
	        _react2.default.createElement(_SideBar2.default, {
	          groups: _Constants.ExamplePages,
	          example: this.props.example
	        }),
	        this.props.children
	      )
	...
	var HomePage = function (_Component) {
	  ...
	  HomePage.prototype.render = function render() {
	    return _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(_Header2.default, { showCover: true }),
	      _react2.default.createElement(
	        _PageBody2.default,
	        null,
	        _react2.default.createElement(_StaticHTMLBlock2.default, { html: _index2.default })
	      )
	    );
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getInstantiatorFunction = __webpack_require__(143)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Menu = __webpack_require__(31);
	var MenuItemCell = __webpack_require__(23);
	var renderCell = __webpack_require__(75);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Scroller = __webpack_require__(159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var assign = __webpack_require__(8);
	var getArrowStyle = __webpack_require__(112);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Region = __webpack_require__(21);
	var assign = __webpack_require__(8);
	var align = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuClass = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderCells = __webpack_require__(156);
	var MenuItem = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var cloneElement = React.cloneElement;
	var getPositionStyle = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrefix     = __webpack_require__(45)
	var forcePrefixed = __webpack_require__(168)
	var el            = __webpack_require__(44)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getStylePrefixed = __webpack_require__(171)
	var properties       = __webpack_require__(80)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getCssPrefixedValue = __webpack_require__(169)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMServer = __webpack_require__(90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ALIGN_TO_NORMALIZED = __webpack_require__(233)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(238)(REGION)
