...
const GITHUB_URL = 'https://github.com/jchristman/react-context-menus';
      ...
      <div className="NavBar">
        <div className="NavBar-container">
          <div className="NavBar-logo">
            <a href="./" target="_self" className="NavBar-logoTitle">React Context Menus</a>
            <p className="NavBar-logoDescription">Context Menus for React</p>
          </div>
